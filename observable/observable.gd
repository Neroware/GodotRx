...
## See: [b]res://reactivex/operators/_count.gd[/b]
func count(predicate = null) -> Observable:
	return GDRx.op.count(predicate).call(self)

## See: [b]res://reactivex/operators/_debounce.gd[/b]
...
## See: [b]res://reactivex/operators/_delaysubscription.gd[/b]
...
## See: [b]res://reactivex/operators/_delaywithmapper.gd[/b]
...
## See: [b]res://reactivex/operators/_dematerialize.gd[/b]
func dematerialize() -> Observable:
	return GDRx.op.dematerialize().call(self)

## See: [b]res://reactivex/operators/_distinct.gd[/b]
...
## See: [b]res://reactivex/operators/_distinctuntilchanged.gd[/b]
...
## See: [b]res://reactivex/operators/_elementordefault.gd[/b]
...
## See: [b]res://reactivex/operators/_exclusive.gd[/b]
func exclusive() -> Observable:
	return GDRx.op.exclusive().call(self)

## See: [b]res://reactivex/operators/_expand.gd[/b]
...
## See: [b]res://reactivex/operators/_flatmap.gd[/b]
...
## See: [b]res://reactivex/operators/_groupbyuntil.gd[/b]
...
## See: [b]res://reactivex/operators/_groupjoin.gd[/b]
...
## See: [b]res://reactivex/operators/_ignoreelements.gd[/b]
func ignore_elements() -> Observable:
	return GDRx.op.ignore_elements().call(self)

## See: [b]res://reactivex/operators/_isempty.gd[/b]
func is_empty() -> Observable:
	return GDRx.op.is_empty().call(self)

## See: [b]res://reactivex/operators/_join.gd[/b]
...
## See: [b]res://reactivex/operators/_last.gd[/b]
func last(predicate = null) -> Observable:
	return GDRx.op.last(predicate).call(self)

## See: [b]res://reactivex/operators/_lastordefault.gd[/b]
...
## See: [b]res://reactivex/operators/_maxby.gd[/b]
...
## See: [b]res://reactivex/operators/_minby.gd[/b]
...
## See: [b]res://reactivex/operators/_multicast.gd[/b]
...
## See: [b]res://reactivex/operators/_pairwise.gd[/b]
...
## See: [b]res://reactivex/operators/_publish.gd[/b]
...
## See: [b]res://reactivex/operators/_publishvalue.gd[/b]
...
## See: [b]res://reactivex/operators/_sample.gd[/b]
...
## See: [b]res://reactivex/operators/_singleordefault.gd[/b]
...
## See: [b]res://reactivex/operators/_skipuntil.gd[/b]
func skip_until(other : Observable) -> Observable:
	return GDRx.op.skip_until(other).call(self)

## See: [b]res://reactivex/operators/_skipuntilwithtime.gd[/b]
...
## See: [b]res://reactivex/operators/_skipwhile.gd[/b]
...
## See: [b]res://reactivex/operators/_skipwithtime.gd[/b]
...
## See: [b]res://reactivex/operators/_sum.gd[/b]
func sum(key_mapper = null) -> Observable:
	return GDRx.op.sum(key_mapper).call(self)

## See: [b]res://reactivex/operators/_switchlatest.gd[/b]
...
## See: [b]res://reactivex/operators/_takeuntil.gd[/b]
func take_until(other : Observable) -> Observable:
	return GDRx.op.take_until(other).call(self)

## See: [b]res://reactivex/operators/_takeuntilwithtime.gd[/b]
...
## See: [b]res://reactivex/operators/_throttlefirst.gd[/b]
...
## See: [b]res://reactivex/operators/_timeoutwithmapper.gd[/b]
...
## See: [b]res://reactivex/operators/_timestamp.gd[/b]
...
## See: [b]res://reactivex/operators/_tolist.gd[/b]
func to_list() -> Observable:
	return GDRx.op.to_list().call(self)

## See: [b]res://reactivex/operators/_toset.gd[/b]
